    ...
    <>
      ...
      <main>
        <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <section className="mb-10">
            <h2 className="font-display text-xl font-semibold text-foreground mb-3">Cosas que pueden mejorar</h2>
            ...
            <div className="mt-5 flex items-start gap-2.5 p-3.5 rounded-xl bg-warning/10 border border-warning/20 text-sm text-foreground leading-relaxed">
              ...
              <p>Este contenido es informativo y no sustituye el consejo de un profesional de la salud. No pretende diagnosticar, tratar, curar ni prevenir ninguna enfermedad. Si tienes alguna condición médica o dudas, consulta con tu médico antes de comenzar.</p>
            </div>
          </section>
